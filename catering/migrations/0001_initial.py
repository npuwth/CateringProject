# Generated by Django 2.1.2 on 2021-09-20 10:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catering.Books', verbose_name='图书')),
            ],
        ),
        migrations.CreateModel(
            name='Librarian',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ManyToManyField(to='catering.Books', verbose_name='图书')),
            ],
        ),
        migrations.AddField(
            model_name='books',
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catering.Publisher', verbose_name='出版社名称'),
        ),
        migrations.AddField(
            model_name='author',
            name='books',
            field=models.ManyToManyField(related_name='author_book', to='catering.Books', verbose_name='图书'),
        ),
    ]
